    ...
    <PageShell>
      ...
      <section className="page-content docs-layout">
        ...
        <article className="prose docs-prose">
          ...
          <section id="verify"><Eyebrow>RiskPack</Eyebrow><h2>Verify all twelve packs</h2><pre><code>npm run cascadelens -- cases verify all</code></pre><p>Verification covers exact file sets, relative paths, checksums, graph digest, schema versions, cross-file IDs, source manifest, status labels, and portable rebuild commands.</p></section>
