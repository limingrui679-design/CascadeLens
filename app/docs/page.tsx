    ...
    <PageShell>
      ...
      <section className="page-content docs-layout">
        ...
        <article className="prose docs-prose">
          ...
          <section id="verify"><Eyebrow>RiskPack</Eyebrow><h2>Recompute all twelve packs</h2><pre><code>npm run cascadelens -- cases verify all</code></pre><p>Verification checks the package structure and then recomputes cascade bounds, intervention analysis, observability, and benchmark output from the packaged graph, ShockScript, observations, and configuration. An optional external expected digest adds publisher-identity checking; neither mode establishes empirical validity.</p></section>
