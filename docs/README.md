...
| [v0.3.0 audit-remediation review](SELF_REVIEW_2026-08-13_v0.3.0.md) | Maps independently reproduced software findings to code, adversarial tests, and release evidence. |
