...
| [v0.2.1 audit-remediation review](SELF_REVIEW_2026-08-13_v0.2.1.md) | Maps independently reproduced software findings to code, adversarial tests, and release evidence. |
