...
NetworkX is optional: `pip install "cascadelens[networkx] @ git+https://github.com/limingrui679-design/CascadeLens.git@v0.4.0"`.
...
Python package version `0.4.0` preserves WorldGraph and ShockScript schema version `0.1.0` and engine semantics `0.2.0`. Automated tests compare Python results with all 12 reviewed browser artifacts to numerical tolerance.
