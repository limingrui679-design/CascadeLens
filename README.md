...
<p align="center">
  ...
  ·
  <a href="docs/SELF_REVIEW_2026-08-13_v0.3.1.md">Inspect the evidence</a>
</p>
...
> [!IMPORTANT]
> **Current release: `v0.3.1`.** CascadeLens is a software-verified research release, not an empirically validated production decision system. Its 12 reference cases are all `scenario_only`: there are **0 historically scored cases, 0 external validations, and 0 claims of organizational adoption**.
...
|---|---|
| Evaluate what the project actually proves | [Acceptance matrix](docs/ACCEPTANCE_MATRIX.md) · [v0.3.1 audit remediation review](docs/SELF_REVIEW_2026-08-13_v0.3.1.md) |
